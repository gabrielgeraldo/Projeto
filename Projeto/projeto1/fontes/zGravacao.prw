...
User Function zGravacao()
	...
	Begin Transaction
		...
		If SB1->(DbSeek(FWxFilial('SB1') + '1000'))
			...
			*/
		Else
			MsgInfo("Registro não alterado porque não foi encontrado!", "Atenção")	
		EndIf
	...
	*/
	...
	SB1->B1_FILIAL     := FWxFilial('SB1')   // Retorna a filial de acordo com as configurações do ERP Protheus
	SB1->B1_DESC       := "teste reclok"
	
	MSUNLOCK()     // Destrava o registro 
	
	MsgInfo("Produto 'teste reclok' incluso!", "Atenção")
